...
/**
 * Featured-creator card. Tapping it hands the template up to the parent,
 * which opens the shared preview → input-modal flow (the same flow
 * blueprint cards use). The card itself owns no modal anymore.
 */
