...
const SHOWCASE_VIDEOS = [
  ...
  { id: 'v1780158596/demo-block-blue_t4pz1u' },
  // The "Untitled" feature ad
  { id: 'v1780158625/Untitled_mxchgo' },
  // Black-box caption variant — the original captioned hero
  { id: 'v1780158722/5b209243-f12b-4d4d-9365-6eac272fa36a_wopbcx' },
].map((v) => ({
  src: cldVideo(v.id, 720),
  poster: cldPoster(v.id, 720),
}));
